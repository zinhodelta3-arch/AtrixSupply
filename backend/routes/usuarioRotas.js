...
router.put('/:id_user', authMiddleware, adminMiddleware, AuthController.atualizarUsuario);
router.delete('/:id_user', authMiddleware, adminMiddleware, AuthController.excluirUsuario);
